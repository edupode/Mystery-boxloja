...
def test_admin_orders():
    ...
    try:
        ...
        # If there are orders, test updating order status
        if orders:
            ...
            response = requests.put(
                f"{API_URL}/admin/orders/{order_id}/status?status=shipped", 
                headers=headers
            )
            ...
            if not updated_order or updated_order.get("order_status") != "shipped":
                return log_test_result("Admin Update Order Status", False, "Order status not updated")
            
            return log_test_result("Admin Orders", True, f"Successfully managed {len(orders)} orders")
        else:
            return log_test_result("Admin Orders", True, "No orders to test with, but endpoint works")
    except Exception as e:
...
def test_admin_products():
    ...
    try:
        ...
        return log_test_result("Admin Products", True, "Successfully managed products")
    except Exception as e:
...
def test_admin_coupons():
    ...
    try:
        ...
        return log_test_result("Admin Coupons", True, "Successfully managed coupons")
    except Exception as e:
...
def test_admin_promotions():
    ...
    try:
        ...
        # Delete (deactivate) the promotion
        ...
        return log_test_result("Admin Promotions", True, "Successfully managed promotions")
    except Exception as e:
...
def test_admin_categories():
    ...
    try:
        ...
        if not any(c["name"] == new_category["name"] for c in categories):
            return log_test_result("Admin Create Category", False, "Category not found after creation")
        
        return log_test_result("Admin Categories", True, "Successfully managed categories")
    except Exception as e:
...
def test_admin_users():
    ...
    try:
        ...
        return log_test_result("Admin Users", True, "Successfully managed admin users")
    except Exception as e:
...
def test_admin_emails():
    ...
    try:
        ...
        return log_test_result("Admin Emails", True, "Successfully sent admin emails")
    except Exception as e:
